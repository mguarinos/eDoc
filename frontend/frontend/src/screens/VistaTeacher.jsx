...
export default function VistaTeacher(props) {
        return (
                        ...
                        <div id="owl-demo" class="owl-carousel header1">
                            <div>
                                <div class="col-xs-12 col-sm-6 col-md-6 header-text">
                                    ...
                                    <h3 class="wow bounceIn animated" data-wow-delay=".50s">CONSULTA TUS EVALUACIONES </h3>
                                    ...
                                    <p>
                                        <div class="btn btn-primary btn-lg btn-ornge wow bounceIn animated" data-wow-delay="1s"><i class="hbtn"></i> <span><button onClick={props.toggleDrawer('left', true)}>Consultar evaluaciones</button></span>
                                        </div>
                                    </p>
                                </div>
                            </div>
